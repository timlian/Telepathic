...
//    }
//
//    public void test_store_consumer_records_2(){
//        mConsumptionStore.deleteAllRecords();
//        for(ConsumerRecord record : mTestConsumerRecords) {
//            mConsumptionStore.insertRecord(record);
//        }
...
//        }
//
//        ConsumptionInfo info = mConsumptionStore.getConsumptionInfo(CARD_ID);
//        try {
//            Utils.copyAppDatabaseFiles("com.telepathic.finder");
//        } catch (IOException e) {
//            // TODO Auto-generated catch block
//            e.printStackTrace();
//        }
//        String residualCount = null;
//        String residualAmount = null;
//        for (ConsumerRecord record : mTestConsumerRecords) {
//            switch(record.getType()){
//                case COUNT:
//                    if (residualCount == null) {
//                        residualCount = record.getResidual();
//                    }
//                    break;
//                case EWALLET:
//                    if (residualAmount == null) {
//                        residualAmount = record.getResidual();
//                    }
//                    break;
//                default:
//                    throw new RuntimeException("Unknown consumer type !!!");
//            }
//            if (residualAmount != null && residualCount != null) {
//                break;
//            }
//        }
//
//        ArrayList<ConsumerRecord> consumerRecords = info.getRecordList();
//        assertEquals(CARD_ID, info.getCardId());
//        assertEquals(residualCount, info.getResidualCount());
//        assertEquals(residualAmount, info.getResidualAmount());
//        assertEquals(mTestConsumerRecords.size(), consumerRecords.size());
//        for(int i = 0; i < mTestConsumerRecords.size(); i++) {
//            assertEquals(mTestConsumerRecords.get(i), consumerRecords.get(i));
//        }
...
//
//}
//>>>>>>> 51c35cfcee1644643cd907b13f447de22392d54d
