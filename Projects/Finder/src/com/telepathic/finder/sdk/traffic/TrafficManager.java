...
public class TrafficManager {
    ...
    public static synchronized TrafficManager getTrafficManager(BMapManager manager, Context appContext) {
        if (mInstance == null) {
...
//		}
		...
		public void getConsumerRecords(String cardId, int count) {
			...
			GetConsumerRecordRequest request = new GetConsumerRecordRequest(mTrafficeMonitor, cardId, count);
