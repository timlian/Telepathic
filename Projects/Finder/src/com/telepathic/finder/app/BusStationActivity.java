...
public class BusStationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(HISTORY_LOADER_ID, null,
    ...
    private void queryData() {
        ...
        sortOrder.append(KuaiXinData.BusStation.LAST_UPDATE_TIME).append(" DESC ")
                .append("LIMIT 0,1");
        Cursor cursor = resolver.query(KuaiXinData.BusStation.CONTENT_URI, null, null, null,
                sortOrder.toString());
        if (cursor != null && cursor.moveToFirst()) {
            ...
            cursor = resolver.query(KuaiXinData.BusStationLines.CONTENT_URI, projection, selection,
                    selectionArgs, null);
            if (cursor != null && cursor.moveToFirst()) {
    ...
    private void setupView() {
        ...
        mGpsNumber.addTextChangedListener(new TextWatcher() {
    ...
    private class StationGpsNumberAdapter implements ListAdapter, Filterable {
        private LayoutInflater mInflater;

        public ArrayList<String> mAutoCompleteStrs = new ArrayList<String>();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final KXBusStation busStation = getStationByGpsNumber(mAutoCompleteStrs.get(position));
            ...
            convertView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    mGpsNumber.setText(busStation.getGpsNumber());
                }
            });
            return convertView;
        }

        private KXBusStation getStationByGpsNumber(String gpsNumber) {
            int position;
            for (KXBusStation station : mRecentStations) {
                if (station.getGpsNumber().equals(gpsNumber)) {
                    return station;
                }
            }
            return null;
        ...
        @Override
        public int getCount() {
            return mAutoCompleteStrs.size();
        }

        @Override
        public Object getItem(int position) {
            return mAutoCompleteStrs.get(position);
        }
        ...
        class MyFilter extends Filter {
            ...
            public MyFilter() {
                super();
                strsContains = mStationGpsNumbers;
            }
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (null != constraint && constraint.length() > 0) {
                    for (String tempStr : strsContains) {
                        if (tempStr.contains(constraint)) {
                            strsTemp.add(tempStr);
                        }
                    }
                    results.values = strsTemp;
                    results.count = strsTemp.size();
                }
                return results;
            }
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                mAutoCompleteStrs = Utils
                        .removeDuplicateWithOrder((ArrayList<String>)results.values);
            }
